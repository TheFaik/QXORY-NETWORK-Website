...
- Проект **[MSN] "QXORY NETWORK"** подразумевает создание деловой сети между серверами игры Minecraft, которые готовы сотрудничать друг с другом, чтобы помогать и достигать своих целей в разных аспектах. 
::: details 🔖 Пример
...
Это напоминает своего рода форум, но тут важная деталь - обязательно нужно быть участником, который вступил в проект **[MSN] "QXORY NETWORK"**. Без этого любая помощь участникам с ролью `Гость` на нашем сервере Discord будет удаляться, а вам, как участнику выдаётся таймаут. Понимаем, что жестоко, но это наша позиция и концепцепция, которую мы хотим развить.
:::
