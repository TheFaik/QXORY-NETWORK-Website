...
- Проект **[MSN] "QROXY NETWORK"** подразумевает создание деловой сети между серверами игры Minecraft, которые готовы сотрудничать друг с другом, чтобы помогать и достигать своих целей в разных аспектах. 
::: details 🔖 Пример
...
Это напоминает своего рода форум, но тут важная деталь - обязательно нужно быть участником, который вступил в проект **[MSN] "QROXY NETWORK"**. Без этого любая помощь участникам с ролью `Гость` на нашем сервере Discord будет удаляться, а вам, как участнику выдаётся таймаут. Понимаем, что жестоко, но это наша позиция и концепцепция, которую мы хотим развить.
:::
...
- Для того, чтобы вступить в наш проект, вы должны зайти на наш сервер **[Discord](https://ds.qroxynet.ru/)** и оформить заявку в канале `cоздать-обращение` и следовать всем **[требованиям](../docs/condition.md)** и правилам.